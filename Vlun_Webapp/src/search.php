...
<body>
   ...
   <div class="w3-top">
      <div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto">
         <div class="header-container">
            ...
            <div class="w3-right w3-padding-16" style="margin-left: 400px;"><button
                  onclick="location.href='./profile.php'"
                  style="text-decoration: none; color: inherit;">Profile</button></div>
            <div class="w3-right w3-padding-16" style="margin-left: 10px;"><button
                  onclick="location.href='./create.php'" style="margin-left:0px;">Create Jeager</button>
            </div>
         </div>
   ...
   <div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
      ...
      <div class="w3-row-padding w3-padding-16 w3-center">
         <?php
         $jeager = "SELECT * FROM jaegers WHERE jeager_name = ?";
         $conn = createConnection();
         $jaeger_query = $conn->prepare($jeager);
         $jaeger_query->bind_param("s", $_GET['query']);
            ...
            while ($jaeger = $jaeger_result->fetch_assoc()) {
               ...
               <div class="w3-quarter" style="max-width:400px;margin-left: 50px">
                  <img src="<?= htmlspecialchars($jaeger['image_path']) ?>"
                     alt="<?= htmlspecialchars($jaeger['jeager_name']) ?>" style="height:200px; width: 300px;">
                  <h3>
